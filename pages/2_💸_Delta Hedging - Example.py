...
df_St = bsmodel.get_default_St(St_sce, T=T)
...
#%% === F區: Delta、Delta-Gamma避險損益比較 ===
st.subheader("Delta、Delta-Gamma避險損益比較")
...
fig1 = px.line(df_all_hedge.round(2), x="t", y=cname, title="Delta、Delta-Gamma避險損益比較", \
               labels={"value":"profit"},height=400, width=700, template="plotly_white")
